...
| ST-068 | Remove debug error handler from web auth serverless function | tech-debt | high | soon | web, auth |
...
| ST-011 | Project read-only view | enhancement | high | low | projects |
| ST-026 | Multiple entries per day feeding into daily entry | enhancement | high | low | log |
...
| ST-007 | Menstrual cycle overlay on wave graph | enhancement | medium | low | reports |
| ST-008 | Privacy controls — teen vs caregiver data separation | enhancement | medium | low | auth, projects |
| ST-009 | Onboarding flow for new accounts and projects | enhancement | medium | low | projects, auth, scoring |
...
| ST-047 | App Store submission and review | enhancement | medium | low | mobile |
...
|----|-------|------|------------|
| ST-010 | Project selection should persist across pages | enhancement | dashboard, history, reports, navigation |
| ST-051 | Set app icon from brand SVG | enhancement | mobile, theming |
| ST-052 | Add branded splash screen | enhancement | mobile, theming |
| ST-053 | Add "Create Account" option to sign-in screen | enhancement | mobile, auth |
| ST-054 | Remove "Import Journal" from hamburger menu | enhancement | mobile, navigation |
| ST-055 | Make AI Journal a proper tab screen with persistent tab bar | bug | mobile, navigation |
| ST-056 | Fix AI Journal page title and redundant header | bug | mobile, navigation |
| ST-060 | Rewrite web app from Next.js to Vite SPA | tech-debt | web, infrastructure |
| ST-065 | Behavior checklist not displaying on mobile log screen | bug | mobile, log |
| ST-067 | Dynamic app icon per build profile (dev vs production) | enhancement | mobile, infrastructure, theming |
...
**Total: 74 issues** (0 in progress, 0 on stage, 1 open-now, 17 open-soon, 41 open-low, 0 deferred, 3 superseded, 12 done)
