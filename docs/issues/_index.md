...
| ST-077 | ProjectProvider silent failure strands dashboard, history, log, entry detail | bug | high | A | mobile, auth, dashboard |
...
**Total: 75 issues** (0 in progress, 9 on stage, 6 Phase A, 11 Phase B, 7 Phase C, 5 Phase D, 7 Phase E, 20 Phase F, 1 deferred, 1 needs verification, 3 superseded, 6 done)
